...
export default function EditGpu() {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div> VramType <input placeholder={data[keys[2]]} aria-label="{keys[2]}" type="text" name={keys[2]} onChange={e => handleChange(e)} required /></div>
            <div> Required PSU <input placeholder={data[keys[3]]} aria-label="{keys[3]}" type="number" name={keys[3]} onChange={e => handleChange(e)} required /></div>
            <div> Length <input placeholder={data[keys[4]]} aria-label="{keys[4]}" type="number" name={keys[4]} onChange={e => handleChange(e)} required /></div>
